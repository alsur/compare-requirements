...
PACKAGE_NAME = 'compare-requirements'
PACKAGE_DOWNLOAD_URL = 'https://github.com/alsur/compare-requirements/archive/master.zip'  # .tar.gz
URL = 'https://github.com/alsur/compare-requirements'
STATUS_LEVEL = 3  # 1:Planning 2:Pre-Alpha 3:Alpha 4:Beta 5:Production/Stable 6:Mature 7:Inactive
KEYWORDS = ['pip', 'freeze', 'compare', 'requirements']  # Palabras clave
...
PYTHON_VERSIONS = ['2.6-2.7', '3.2-3.6']
